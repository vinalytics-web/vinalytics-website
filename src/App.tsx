            ...
            <form onSubmit={handleSubmit} className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 rounded-lg bg-input border border-border text-foreground font-body text-sm placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-ring/50 transition-all"
                />
              </div>
              <button
                type="submit"
